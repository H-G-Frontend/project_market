...
const toggleContainer = function () {
  if (navMenu.classList.contains("nav-menu")) {
    ...
    buttonShowMoreText.style.backgroundImage = 'url("icon/expand2.svg")';
    buttonShowMoreText.style.width = "100px";
  } else {
    navMenu.classList.remove("nav-menu--opened");
    navMenu.classList.add("nav-menu");
    buttonShowMoreText.textContent = "Показать все";
    buttonShowMoreText.style.backgroundImage = 'url("icon/expand.svg")';
    buttonShowMoreText.style.width = "150px";
  }
};
